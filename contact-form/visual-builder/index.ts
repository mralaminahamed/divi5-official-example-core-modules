...
import { type ContactFormAttrs, type ModuleLibrary } from '@divi/types';

import { generateUniqueId, isVisibleFields, itemTitleCallback } from './callbacks';
...
/**
 * Custom elements callbacks for Contact Form module.
 * Overrides itemTitleCallback to use fieldItem.innerContent.desktop.value.
 */
const contactFormElementsCallbacks = {
  ...elementsCallbacks,
  itemTitleCallback,
};
...
export const contactForm: ModuleLibrary.Module.RegisterDefinition<ContactFormAttrs> = {
  ...
  callbacks: {
    content: {
      elements: contactFormElementsCallbacks,
      contentRedirect: {
        fields: {
