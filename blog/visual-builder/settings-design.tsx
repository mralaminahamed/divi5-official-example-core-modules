...
import { isVisibleFields, isVisibleGroup } from './callbacks';
 ...
 */
export const SettingsDesign = ({ groupConfiguration }: Module.Settings.Panel.Props<BlogAttrs>): ReactElement => {
  ...
  if (groupConfiguration?.designOverlay?.component) {
    ...
    set(
      groupConfiguration,
      ['designOverlay', 'component', 'props', 'fields', 'overlayDecorationBackground', 'visible'],
      isVisibleFields,
    );
  ...
  if (groupConfiguration?.designBorder?.component) {
    set(
      groupConfiguration,
      ['designBorder', 'component', 'props', 'fields', 'postDecorationBorder', 'component', 'props', 'visible'],
      isVisibleGroup,
    );
    set(
      groupConfiguration,
      ['designBorder', 'component', 'props', 'fields', 'fullwidthDecorationBorder', 'component', 'props', 'visible'],
      isVisibleGroup,
    );
  }
