...
export const SettingsDesign = ({
  ...
  const useFocusBorderCallback = (params: Module.Settings.Group.VisibleCallback.Params<ContactFieldAttrs>) => {
    const useFocusBorder =
      getAttrValue({
  ...
  if (groupConfiguration?.designBorder?.component?.props) {
    set(
      groupConfiguration,
      ['designBorder', 'component', 'props', 'fields', 'focusBorderGroup', 'component', 'props', 'visible'],
      useFocusBorderCallback,
    );
  }
