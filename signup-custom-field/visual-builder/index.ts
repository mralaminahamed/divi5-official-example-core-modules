...
import { type ModuleLibrary, type SignupCustomFieldAttrs } from '@divi/types';

import { conversionOutline } from './conversion-outline';
import { SignupCustomFieldEdit } from './edit';
...
import { optionGroupPresetPrimaryAttrNameResolverSignupCustomField } from './option-group-preset-resolver';
import { SettingsContent } from './settings-content';
import { SettingsDesign } from './settings-design';

// Register the filters for Option Group Preset Data Resolver.
addFilter(
  'divi.optionGroupPresetPrimaryAttrNameResolver.diviSignupCustomField',
  'divi',
