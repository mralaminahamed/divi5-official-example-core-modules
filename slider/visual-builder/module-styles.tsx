...
import { removeTextShadowStyleDeclaration } from '@divi/module-utils';
import { overflowForBorderRadiusStyleDeclaration } from '@divi/style-library';
import { type SliderAttrs } from '@divi/types';

import { cssFields } from './custom-css';
import { buttonAlignmentStyleDeclaration } from './style-declarations';
...
const ModuleStyles = ({
  ...
  <StyleContainer mode={mode} state={state} noStyleTag={noStyleTag}>
        ...
        advancedStyles: [
          ...
          },
          {
            ...
            props: {
              ...
              declarationFunction: removeTextShadowStyleDeclaration,
            },
          },
        ],
      },
     ...
     */}
    <CssStyle selector={`${orderClass}.et_pb_slider`} attr={attrs.css} cssFields={cssFields} />
  </StyleContainer>
);
