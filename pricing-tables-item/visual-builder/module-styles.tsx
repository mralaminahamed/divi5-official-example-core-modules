...
import { pricingTableBodyContentStyleDeclaration } from '../pricing-tables/style-declarations';
  ...
  return (
    <StyleContainer mode={mode} state={state} noStyleTag={noStyleTag}>
          ...
          advancedStyles: [
            {
              componentName: 'divi/common',
              props: {
                selector: `${orderClass}.et_pb_pricing_table .et_pb_pricing li`,
      ...
      {elements.style({
        attrName: 'button',
        styleProps: {
          attrsFilter: decorationAttrs => filterButtonDecorationAttrs(decorationAttrs, parentButtonAttr),
        },
      })}
      {/* Module
