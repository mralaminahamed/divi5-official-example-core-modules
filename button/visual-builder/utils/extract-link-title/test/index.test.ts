...
describe('extractLinkTitle', () => {
  ...
  it('should extract the title from a link with a class, target, and rel', () => {
    const link =
      '<a class="example" href="https://www.example.com" target="_blank" rel="noopener noreferrer" title="My Title Example">Example</a>';
    const title = extractLinkTitle(link);
  ...
  it('should extract the title from a link with HTML tag within the title', () => {
    const link =
      '<a class="example" href="https://www.example.com" target="_blank" rel="noopener noreferrer" title="My Title Example"><strong>Strong</strong> Example</a>';
    const title = extractLinkTitle(link);
