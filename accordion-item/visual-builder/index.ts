...
import { type AccordionItemAttrs, type ModuleLibrary } from '@divi/types';
...
import { optionGroupPresetPrimaryAttrNameResolverAccordionItem } from './option-group-preset-resolver';
import { placeholderContent } from './placeholder-content';
import { SettingsDesign } from './settings-design';

// Register the filters for Option Group Preset Data Resolver.
addFilter(
  'divi.optionGroupPresetPrimaryAttrNameResolver.diviAccordionItem',
  'divi',
